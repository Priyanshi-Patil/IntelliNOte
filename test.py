...
with open("F:\Python Codes\IntelliNote\index1.html", "r") as f:
    html_code = f.read()
...
cert_file = r"C:\\Users\\hp\\ca-cerrt.pem"
key_file = r"C:\\Users\\hp\\ca-keey.pem"
...
max_summary_length = st.number_input("Maximum Summary Length (words):", min_value=500, max_value=5000, value=2500)
if youtube_link:
    try:
        ...
        response = requests.get(thumbnail_url, verify=cert_file)
...
if st.button("Generate My Notes"):
    ...
    if transcript_text:
        ...
        summary = generate_gemini_content(transcript_text,prompt=any)
